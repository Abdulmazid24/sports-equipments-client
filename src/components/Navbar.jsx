    ...
    <div className="navbar bg-gradient-to-r from-indigo-950 via-black to-indigo-950 text-white fixed top-0 left-0 w-full bg-blue-600  shadow-lg z-50 border-b border-inherit">
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul
            tabIndex={0}
            className="menu menu-sm dropdown-content bg-gray-700 rounded-box z-[1] mt-3 w-52 p-2 shadow font-bold"
          >
            <li>
      ...
      <div className="navbar-center hidden lg:flex text-white bg-gray-700">
